...
<html><head>
    ...
    <link rel="stylesheet" href="/public/static/dist/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="/public/static/dist/css/ionicons.min.css">
    ...
    <link rel="stylesheet" href="/public/static/my/css/my.css">
...
<div class="wrapper">
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <a href="#" class="" onclick="return   window.history.back()" style="color: white" role="button">

                <i class="fa  fa-angle-left" style="    font-size: 1.7em;    margin-top: 12px;    margin-left: 13px;"></i>
            </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 200px;"><ul class="menu" style="overflow: hidden; width: 100%; height: 200px;">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="&#10;&#10;http://wx.qlogo.cn/mmopen/J5sNYKndwPVCnhlZEUyjTVTDtyiaWVyPE8fWgx6WhWjGgwpRVbtF5798DfuicvY1kzqpLK3NdwAADIGw9ibCdKES4qUNEuFNvJY/0" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="/public/static/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="/public/static/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="&#10;&#10;http://wx.qlogo.cn/mmopen/J5sNYKndwPVCnhlZEUyjTVTDtyiaWVyPE8fWgx6WhWjGgwpRVbtF5798DfuicvY1kzqpLK3NdwAADIGw9ibCdKES4qUNEuFNvJY/0" class="user-image" alt="User Image">
                            <span class="hidden-xs">张阳</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            ...
                            <li class="user-body">
                                <div class="row">
                                    <div class="col-xs-4 text-center">
                                        <a href="/index/index/index.html">我要拼车</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                                        <a href="/index/seting/index.html">个人中心</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                                        <a href="/index/line/creatline.html">发布行程</a>
                                    </div>
                                </div>
                                <!-- /.row -->
                            </li>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="/index/index/signout.html" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#" class="sidebar-toggle" data-toggle="control-sidebar"></a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div class="content-wrapper" style="min-height: 576px;">
        ...
        <footer class="main-footer">
            ...
            <strong>版权所有 ©  <a href="#">张阳制作</a>.</strong> All rights       reserved.
        </footer>
